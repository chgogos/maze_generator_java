...
public class MazeSolver {
	 ...
	 * version, which looks better visually.) Also, converts each line of the maze
	 * from a String to a char[], because we'll want mutability when drawing the
	 * solution later.
	 */
	 ...
	 * direction we came from, return true if the maze is solvable, and draw the
	 * solution if so.
	 */
	...
	/**
	 * Solve the maze and draw the solution. For simplicity, assumes the starting
	 * point is the lower right, and the ending point is the upper left.
	 */
	...
	/**
	 * Opposite of decimateHorizontally(). Adds extra characters to make the maze
	 * "look right", and converts each line from char[] to String at the same time.
	 */
	 ...
	 * http://rosettacode.org/wiki/Maze_generation#Java in a file whose name is
	 * specified as a command-line argument, or on standard input if no argument is
	 * specified.
	 */
